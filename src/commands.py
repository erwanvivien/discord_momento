...
EPITA = ARCS + BACHELOR + ING1 + MAJEURES + \
    APPRENTISAGE + PREPA + INTER  # + SUMMER + PREPA_SHARP
...
# CLASSES2 = ["ANGLAIS GC", "ANGLAIS KF", "BACTERIOLOGIE BT2", "BIOCHIMIE (TD) BT2", "BIOCHIMIE (cours) BT2",
...
ALL_list = EPITA  # + ADM + ASSO + EPITECH  + ETNA + BIOTECH
